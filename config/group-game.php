            ...
            'thu_thach_do_luong'           => [
                ...
                'games'       => [
                    'length_measurement'  => [
                        'icon'        => '📏',
                        'title'       => 'Đo Độ Dài',
                        'description' => 'So sánh, nhận biết và chọn vật có độ dài lớn nhất hoặc nhỏ nhất trong nhóm.',
                        'route'       => 'game.lop4.measurement_challenges.length_measurement',
                        'status'      => true,
                    ],
                    'fruit_weighing'      => [
                        'icon'        => '🍏🍊',
                        'title'       => 'Cân Táo Cân Cam',
                        'description' => 'So sánh khối lượng các loại quả, chọn quả nặng hơn hoặc nhẹ hơn một cách trực quan.',
                        'route'       => 'game.lop4.measurement_challenges.fruit_weighing',
                        'status'      => true,
                    ],
                    'unit_conversion'     => [
                        'icon'        => '🔄',
                        'title'       => 'Chuyển Đổi Đơn Vị Thần Tốc',
                        'description' => 'Chuyển đổi nhanh giữa các đơn vị đo lường qua các câu hỏi thực tế, sinh động.',
                        'route'       => 'game.lop4.measurement_challenges.unit_conversion',
                        'status'      => true,
                    ],
                    'conversion_table'    => [
                        'icon'        => '📊',
                        'title'       => 'Bảng Quy Đổi',
                        'description' => 'Kéo thả số đúng vào bảng để hoàn thành quy đổi giữa các đơn vị đo lường.',
                        'route'       => 'game.lop4.measurement_challenges.conversion_table',
                        'status'      => true,
                    ],
                    'distance_comparison' => [
                        'icon'        => '🏁',
                        'title'       => 'Cuộc Đua Đơn Vị Đo',
                        'description' => 'So sánh các khoảng cách, xác định quãng đường dài nhất hoặc ngắn nhất.',
                        'route'       => 'game.lop4.measurement_challenges.distance_comparison',
                        'status'      => true,
                    ],
                    'weight_sorting'      => [
                        'icon'        => '📦',
                        'title'       => 'Xếp Hàng Theo Khối Lượng',
                        'description' => 'Sắp xếp các vật thể theo thứ tự khối lượng tăng dần hoặc giảm dần.',
                        'route'       => 'game.lop4.measurement_challenges.weight_sorting',
                        'status'      => true,
                    ],
                    'precision_timing'    => [
                        'icon'        => '⏱️',
                        'title'       => 'Bấm Giờ Chuẩn',
                        'description' => 'Bấm giờ chính xác theo yêu cầu, rèn luyện cảm nhận và kỹ năng về thời gian.',
                        'route'       => 'game.lop4.measurement_challenges.precision_timing',
                        'status'      => true,
                    ],
                    'advanced_time'       => [
                        'icon'        => '⏳',
                        'title'       => 'Thời Gian Nâng Cao',
                        'description' => 'Giải các bài toán nâng cao về thời gian: tính khoảng cách, xác định thời điểm.',
                        'route'       => 'game.lop4.measurement_challenges.advanced_time',
                        'status'      => true,
                    ],
                    'time_adventure'      => [
                        'icon'        => '🚀',
                        'title'       => 'Thời Gian Phiêu Lưu',
                        'description' => 'Tính toán thời gian bắt đầu, kết thúc trong các tình huống phiêu lưu thú vị.',
                        'route'       => 'game.lop4.measurement_challenges.time_adventure',
                        'status'      => true,
                    ],
                    'time_comparison'     => [
                        'icon'        => '⏰',
                        'title'       => 'So Sánh Thời Gian',
                        'description' => 'Sắp xếp, so sánh các khoảng thời gian từ ngắn đến dài qua các thử thách.',
                        'route'       => 'game.lop4.measurement_challenges.time_comparison',
                        'status'      => true,
                    ],
                    'weight_estimation'   => [
                        'icon'        => '⚖️',
                        'title'       => 'Ước Lượng Khối Lượng',
                        'description' => 'Ước lượng, so sánh khối lượng các vật thể quen thuộc, phát triển cảm nhận thực tế.',
                        'route'       => 'game.lop4.measurement_challenges.weight_estimation',
                        'status'      => true,
                    ],
                ],
            ],
