...
function renderQuestion(){
    ...
    switch(q.shape){
        ...
        case 'hình thang': html+=`<div class="relative w-40 h-32 mx-auto"><div class="absolute inset-0 border-4 border-blue-500 transform skew-x-12 bg-blue-50"></div></div><p class="mt-2">ĐLớn = ${q.dimensions['đáy lớn']} cm, ĐNhỏ = ${q.dimensions['đáy nhỏ']} cm, Cao = ${q.dimensions['chiều cao']} cm</p>`; break;
