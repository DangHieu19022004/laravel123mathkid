...
@section('title', 'Tâm Nhảy Phân Số')
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <div class="text-center mb-4">
                        <h4>Tìm phân số tiếp theo trong dãy:</h4>
                    </div>
                    ...
                    <div class="text-center mt-4">
                        <a href="{{ route('games.lop4.phanso.pattern.reset') }}" class="btn btn-secondary">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        fetch('{{ route("games.lop4.phanso.pattern.check") }}', {
            method: 'POST',
            headers: {
